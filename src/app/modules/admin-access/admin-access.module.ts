...
import { CreateShowComponent } from './create-show/create-show/create-show.component';
import { CreateContentComponent } from './create-content/create-content.component';

@NgModule({
  declarations: [
    UsersComponent,
    ListYourShowComponent, CreateVenueComponent, CreateContentComponent, CreateShowComponent
  ],
  imports: [
