...
export const citiesJson = [
  ...
  { id: 26, name: "Meerut" },
  { id: 27, name: "Rajkot" },
  { id: 28, name: "Kalyan-Dombivli" },
  { id: 29, name: "Vasai-Virar" },
  { id: 30, name: "Varanasi" },
  { id: 31, name: "Srinagar" },
  { id: 32, name: "Aurangabad" },
  { id: 33, name: "Dhanbad" },
  { id: 34, name: "Amritsar" },
  { id: 35, name: "Navi Mumbai" },
  { id: 36, name: "Allahabad (Prayagraj)" },
  { id: 37, name: "Ranchi" },
  { id: 38, name: "Howrah" },
  { id: 39, name: "Coimbatore" },
  { id: 40, name: "Jabalpur" },
  { id: 41, name: "Gwalior" },
  { id: 42, name: "Vijayawada" },
  { id: 43, name: "Madurai" },
  { id: 44, name: "Raipur" },
  { id: 45, name: "Kota" },
  { id: 46, name: "Chandigarh" },
  { id: 47, name: "Guwahati" },
  { id: 48, name: "Hubli-Dharwad" },
  { id: 49, name: "Mysuru" },
  { id: 50, name: "Tiruchirappalli" },
  { id: 51, name: "Bareilly" },
  { id: 52, name: "Aligarh" },
  { id: 53, name: "Moradabad" },
  { id: 54, name: "Jodhpur" },
  { id: 55, name: "Salem" },
  { id: 56, name: "Warangal" },
  { id: 57, name: "Guntur" },
  { id: 58, name: "Bhubaneswar" },
  { id: 59, name: "Cuttack" },
  { id: 60, name: "Dehradun" }
]
