export const movies = [
  ...
  },
  {
    ...
    Actors:
      'Christian Bale, Cate Blanchett, Benedict Cumberbatch, Naomie Harris',
  ...
  },
  {
    ...
    Writer: 'Sandra Goldbacher (screenplay), Laurence Coriat (screenplay)',
    Actors: 'Ella Jones, Anna Popplewell, Cameron Powrie, Trudie Styler',
    Plot: 'Two best friends grow up on the Isle of Wight and in Brighton in the 1970s and 1980s.',
    Language: 'English, French',
    Country: 'UK, Germany',
    Awards: '2 nominations.',
    Poster:
      'https://m.media-amazon.com/images/M/MV5BMTIyNDIwNzY4Nl5BMl5BanBnXkFtZTYwNjE4NDA3._V1_SX300.jpg',
    Ratings: [
    ...
    Website: 'http://www.mewithoutyoumovie.com/movie.html',
    Response: 'True',
  },
  // {
  //   Title: "Pokemon: Pikachu's Rescue Adventure",
  //   Year: '1999',
  //   Rated: 'N/A',
  //   Released: '21 Jul 2000',
  //   Runtime: '20 min',
  //   Genre: 'Animation, Short, Adventure, Family, Fantasy',
  //   Director: 'Michael Haigney, Kunihiko Yuyama',
  //   Writer: 'Hideki Sonoda (screenplay), Satoshi Tajiri (characters)',
  //   Actors: 'Ikue Ôtani, Rikako Aikawa, Madeleine Blaustein, Michael Haigney',
  //   Plot: 'Togepi leads Pikachu and friends on a wild adventure.',
  //   Language: 'Japanese',
  //   Country: 'Japan',
  //   Awards: 'N/A',
  //   Poster:
  //     'https://m.media-amazon.com/images/M/MV5BNTdiZTNmNDAtODUyZC00NGU5LWEyMDEtOWU5NDFmMDg2ZTMwXkEyXkFqcGdeQXVyMzc5ODkzNDE@._V1_SX300.jpg',
